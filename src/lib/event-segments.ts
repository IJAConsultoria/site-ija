...
> = {
  ...
  "lucro-real-30-minutos": {
    restaurantes: {
      headline: "Dono de Restaurante: Descubra seu Lucro Real em 30 Minutos",
      subheadline:
        "Você sabe quanto realmente sobra no fim do mês? A maioria dos restaurantes confunde faturamento com lucro.",
      description:
        "Live 100% prática para donos de restaurante que querem sair do escuro financeiro. João Pedro Alves mostra o passo a passo para calcular seu lucro real — com ferramentas que você já tem no restaurante.",
      forWho: [
        "Donos de restaurante que não sabem o lucro real",
        "Restaurantes que faturam acima de R$ 100 mil/mês mas não veem o dinheiro",
        "Gestores que confundem faturamento com lucro",
      ],
      painPoint: "Não sei quanto realmente lucro no meu restaurante",
    },
    hamburguerias: {
      headline:
        "Dono de Hamburgueria: Descubra seu Lucro Real em 30 Minutos",
      subheadline:
        "Seu CMV está correto? A margem do burger artesanal pode estar comendo seu lucro sem você perceber.",
      description:
        "Live 100% prática para donos de hamburgueria que querem parar de voar no escuro. Aprenda a calcular o lucro real da sua operação — do insumo ao prato servido.",
      forWho: [
        "Donos de hamburgueria que não controlam o CMV por produto",
        "Hamburguerias com ticket médio alto mas lucro baixo",
        "Operações delivery + salão sem separação de custos",
      ],
      painPoint: "Vendo muito burger mas não vejo o lucro",
    },
    pizzarias: {
      headline: "Dono de Pizzaria: Descubra seu Lucro Real em 30 Minutos",
      subheadline:
        "Rodízio, delivery ou à la carte — cada modelo tem margens diferentes. Você está calculando certo?",
      description:
        "Live 100% prática para donos de pizzaria. Aprenda a calcular seu lucro real separando custos por canal de venda e modelo de operação.",
      forWho: [
        "Donos de pizzaria que misturam custos de delivery e salão",
        "Pizzarias com alto faturamento no fim de semana mas caixa apertado",
        "Operações de rodízio sem controle de margem por cliente",
      ],
      painPoint: "Faturamento alto nos fins de semana mas caixa sempre apertado",
    },
    bares: {
      headline: "Dono de Bar: Descubra seu Lucro Real em 30 Minutos",
      subheadline:
        "A margem de bebidas é alta, mas o lucro some? O problema pode estar nos custos que você não enxerga.",
      description:
        "Live 100% prática para donos de bar, pub e lounge. Aprenda a calcular seu lucro real considerando perdas, happy hour e mix de produtos.",
      forWho: [
        "Donos de bar que não separam margem de bebida vs. petisco",
        "Bares com movimento cheio mas caixa vazio",
        "Operações com happy hour sem saber se dá lucro",
      ],
      painPoint: "Casa cheia todo fim de semana mas dinheiro não sobra",
    },
    cafeterias: {
      headline: "Dono de Cafeteria: Descubra seu Lucro Real em 30 Minutos",
      subheadline:
        "Café especial, brunch, confeitaria — margens que parecem boas mas escondem custos invisíveis.",
      description:
        "Live 100% prática para donos de cafeteria, confeitaria e padaria gourmet. Descubra como calcular o lucro real com produção própria e mix variado.",
      forWho: [
        "Donos de cafeteria com produção própria sem custeio por receita",
        "Confeitarias que não sabem a margem real de cada produto",
        "Padarias gourmet com mix grande e controle zero",
      ],
      painPoint: "Produção própria bonita no Instagram mas lucro incerto",
    },
    "food-service": {
      headline:
        "Dono de Food Service: Descubra seu Lucro Real em 30 Minutos",
      subheadline:
        "Food truck, dark kitchen ou catering — operações enxutas que perdem dinheiro por falta de controle.",
      description:
        "Live 100% prática para operações de food service. Aprenda a calcular o lucro real do seu modelo de negócio — delivery, eventos ou produção sob demanda.",
      forWho: [
        "Donos de dark kitchen sem visibilidade financeira por marca",
        "Food trucks que não separam custos fixos de variáveis",
        "Operações de catering sem margem definida por evento",
      ],
      painPoint: "Operação rodando mas sem saber se cada canal dá lucro",
    },
    varejo: {
      headline:
        "Dono de Negócio no Varejo: Descubra seu Lucro Real em 30 Minutos",
      subheadline:
        "Markup não é lucro. Descubra quanto realmente sobra depois de todos os custos da operação.",
      description:
        "Live 100% prática para donos de lojas e redes de varejo. Aprenda a calcular seu lucro real além do markup — incluindo custos operacionais que corroem sua margem.",
      forWho: [
        "Donos de loja que confundem markup com lucro",
        "Redes de varejo sem DRE por unidade",
        "Franqueados que não sabem o retorno real do investimento",
      ],
      painPoint: "Vendo bastante mas o dinheiro não aparece no final do mês",
    },
    turismo: {
      headline:
        "Dono de Negócio Turístico: Descubra seu Lucro Real em 30 Minutos",
      subheadline:
        "Alta temporada fatura, baixa temporada come o lucro. Você sabe o resultado anual real?",
      description:
        "Live 100% prática para donos de pousadas, hotéis, agências e negócios turísticos. Aprenda a calcular seu lucro real considerando a sazonalidade do setor.",
      forWho: [
        "Donos de pousada/hotel que só faturam na alta temporada",
        "Agências de turismo sem controle de margem por pacote",
        "Negócios turísticos com custos fixos altos e receita sazonal",
      ],
      painPoint: "Temporada boa mas no ano inteiro o lucro desaparece",
    },
  },

  // ========== EVENTO 2: 3 ERROS DE CRESCIMENTO ==========
  "3-erros-crescimento": {
    restaurantes: {
      headline:

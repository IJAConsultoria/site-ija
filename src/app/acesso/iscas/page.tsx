  ...
  return (
    <div>
      <div className="mb-6 flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-navy-950">Iscas Digitais</h1>
          <p className="mt-1 text-sm text-navy-600">{items.length} iscas</p>
        </div>
        <button
      ...
      {loading ? (
        ...
        <div className="rounded-xl border border-gray-200 bg-gray-50 p-12 text-center">
          ...
          <p className="text-sm text-navy-600">Nenhuma isca digital ainda.</p>
        </div>
      ) : (
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {items.map((m) => (
            <div key={m.id} className="overflow-hidden rounded-xl border border-gray-200 bg-gray-50">
              {m.cover_url && (
              ...
              <div className="p-4">
                ...
                <p className="line-clamp-2 text-xs text-navy-600">{m.description}</p>
          ...
          <div className="max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-2xl border border-gray-200 bg-white p-6">
            ...
            <div className="space-y-4">
              <div className="grid gap-3 sm:grid-cols-2">
                <div>
                  <label className="mb-1 block text-xs text-navy-600">Tipo</label>
                  <select
                    value={editing.type}
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                <div>
                  <label className="mb-1 block text-xs text-navy-600">Texto do CTA</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="mb-1 block text-xs text-navy-600">URL do CTA (form)</label>
                  <input
                    type="text"
